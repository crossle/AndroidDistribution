...
import me.crossle.android.distribution.R;
...
public class PieChart extends ViewGroup {
     ...
     *                {@link me.crossle.android.distribution.R.styleable.PieChart} as well as attributes inherited
    ...
    private void onDataChanged() {
        ...
        for (Item it : mData) {
            ...
            it.mEndAngle = ((float) currentAngle + it.mValue * 360.0f / mTotal);
            ...
            it.mShader = new SweepGradient(
                    ...
                    new float[]{
                            0,
                            (360 - it.mEndAngle) / 360.0f,
                            (360 - it.mStartAngle) / 360.0f,
                            1.0f
                    }
            );
        }
